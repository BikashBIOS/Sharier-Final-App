...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public ImageButton downloadBtn,shareLink;
    ...
    public void setExoplayer(Context application , String name, String Videourl){
        ...
        shareLink=itemView.findViewById(R.id.shareVideo);
